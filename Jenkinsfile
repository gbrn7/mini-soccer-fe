pipeline {
  ...
  stages {
    ...
    stage('Checkout Code') {
      steps {
        script {
          def repoUrl = 'https://github.com/gbrn7/mini-soccer-fe.git'
    ...
    stage('Commit and Push Changes') {
      steps {
        script {
          ...
          git remote set-url origin https://${GITHUB_CREDENTIALS_USR}:${GITHUB_CREDENTIALS_PSW}@github.com/gbrn7/mini-soccer-fe.git
    ...
    stage('Deploy to Remote Server') {
      steps {
        script {
          def targetDir = "/home/gibra/mini-soccer-project/mini-soccer-fe"
